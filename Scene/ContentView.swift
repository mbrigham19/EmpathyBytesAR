...
struct Home : View {
    ...
    @State var models = [
        ...
        Model(id: 0, name: "Example", modelName: "Earth.usdz", details: "This is a test"),
        
        Model(id: 0, name: "Jupiter", modelName: "Scan_12-07-57.arobject", details: "Jupiter is the largest planet in our solar system at nearly 11 times the size of Earth and 317 times its mass. Jupiter, being the biggest planet, gets its name from the king of the ancient Roman gods."),
